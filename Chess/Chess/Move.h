...
{
	START_POSITION =	0b000000000000000000111111,
	END_POSITION   =	0b000000000000111111000000,
	MOVE_TYPE      =	0b000000000111000000000000,
	CAPTURE_TYPE   =	0b000000111000000000000000,
	PROMOTE_TYPE   =	0b000111000000000000000000,
	PIECE_TYPE	   =	0b111000000000000000000000,
};
...
Move				CreateMove(unsigned int startPosition, unsigned int endPosition, MoveType moveType,PieceType pieceType, PieceType captureType, PieceType promoteType = PieceType::NONE);
